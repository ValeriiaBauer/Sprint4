...
public class OrderPageScooter {
    ...
    private void setSubway(String subway) {
        ...
        By stationLocator = By.xpath(String.format(".//div[@class='select-search__select']//*[text()='%s']", subway));
    ...
    public void setScooterColor(String color) {
        ...
        switch(normalizedColor) {
            case "черный жемчуг":
                colorLocator = BLACK_COLOR_CHECKBOX;
                break;
            case "серая безысходность":
                colorLocator = GREY_COLOR_CHECKBOX;
                break;
            default:
